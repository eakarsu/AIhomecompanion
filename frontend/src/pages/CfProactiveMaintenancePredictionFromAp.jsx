...
// Auto-generated page for: Proactive maintenance prediction from appliance age + sensor

export default function CfProactiveMaintenancePredictionFromAp() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-proactive-maintenance-prediction-from-ap', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Proactive maintenance prediction from appliance age + sensor</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Proactive maintenance prediction from appliance age + sensor signatures.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Proactive maintenance prediction from appliance age + sensor'}
        </button>
      </form>
