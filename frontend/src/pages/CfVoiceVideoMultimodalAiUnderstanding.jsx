...
// Auto-generated page for: Voice + video multimodal AI understanding person/room/activi

export default function CfVoiceVideoMultimodalAiUnderstanding() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-voice-video-multimodal-ai-understanding-', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Voice + video multimodal AI understanding person/room/activi</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Voice + video multimodal AI understanding person/room/activity context.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Voice + video multimodal AI understanding person/room/activi'}
        </button>
      </form>
