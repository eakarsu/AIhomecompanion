...
// Auto-generated page for: Multi-home energy arbitrage with demand-response participati

export default function CfMultiHomeEnergyArbitrageWithDemand() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-multi-home-energy-arbitrage-with-demand', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Multi-home energy arbitrage with demand-response participati</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Multi-home energy arbitrage with demand-response participation.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Multi-home energy arbitrage with demand-response participati'}
        </button>
      </form>
