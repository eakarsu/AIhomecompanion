...
// Auto-generated page for: No expense-optimizer for service cancellations

export default function GapNoExpenseOptimizerForServiceCancell() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-expense-optimizer-for-service-cancell', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No expense-optimizer for service cancellations</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No expense-optimizer for service cancellations</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No expense-optimizer for service cancellations'}
        </button>
      </form>
