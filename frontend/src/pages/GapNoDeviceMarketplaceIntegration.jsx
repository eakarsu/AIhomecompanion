...
// Auto-generated page for: No device marketplace integration

export default function GapNoDeviceMarketplaceIntegration() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-device-marketplace-integration', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No device marketplace integration</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No device marketplace integration</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No device marketplace integration'}
        </button>
      </form>
