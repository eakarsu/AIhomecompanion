...
// Auto-generated page for: Family activity clustering auto-creating scenes and surfacin

export default function CfFamilyActivityClusteringAutoCreating() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-family-activity-clustering-auto-creating', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Family activity clustering auto-creating scenes and surfacin</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Family activity clustering auto-creating scenes and surfacing new automations.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Family activity clustering auto-creating scenes and surfacin'}
        </button>
      </form>
