...
// Auto-generated page for: Real-time energy demand shifting auto-moving high-consumptio

export default function CfRealTimeEnergyDemandShiftingAuto() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-real-time-energy-demand-shifting-auto', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Real-time energy demand shifting auto-moving high-consumptio</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Real-time energy demand shifting auto-moving high-consumption tasks to off-peak.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Real-time energy demand shifting auto-moving high-consumptio'}
        </button>
      </form>
