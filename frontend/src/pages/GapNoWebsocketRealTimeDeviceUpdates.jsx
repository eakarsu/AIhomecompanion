...
// Auto-generated page for: No WebSocket real-time device updates

export default function GapNoWebsocketRealTimeDeviceUpdates() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-websocket-real-time-device-updates', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No WebSocket real-time device updates</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No WebSocket real-time device updates</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No WebSocket real-time device updates'}
        </button>
      </form>
